...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"js/carousel.js":[function(require,module,exports) {
"use strict";
...
function carousel() {
  var carouselItem = document.querySelectorAll('.carousel__container');
  var thumb = document.querySelectorAll('.thumb');
  var scroll = function scroll(id) {
    return carouselItem[id].scrollIntoView({
      behavior: 'smooth',
      block: 'nearest',
      inline: 'center'
    });
